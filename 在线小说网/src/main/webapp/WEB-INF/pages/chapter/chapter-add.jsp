        ...
        <form class="layui-form">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_username" name="chapterName" required="" lay-verify="nikename"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                    <span class="x-red">*</span>书的编号
                </label>
                <div class="layui-input-inline">
                    <input type="text"  name="bookId" required="" lay-verify="nikename" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label  class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text"  name="chapterContent" required="" lay-verify="nikename" class="layui-input" id="textContent">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text"  name="chapterWordNumber" required="" lay-verify="nikename" class="layui-input" id="contentNum">
                </div>
            </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
