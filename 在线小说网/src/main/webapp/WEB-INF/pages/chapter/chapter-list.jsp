...
<html>
  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/chapter/search" method="post">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加章节','${pageContext.request.contextPath}/chapter/addPage',600,400)"><i class="layui-icon"></i>添加</button>
        ...
        <tbody>
          <c:forEach items="${list}" var="chapter">
            <tr>
              ...
              <td>${chapter.chapterWordNumber}</td>
              ...
              <td class="td-manage">
                ...
                <%--</a>--%>
                <a title="编辑"  onclick="x_admin_show('编辑','${pageContext.request.contextPath}/chapter/editPage?chapterId=${chapter.chapterId}',600,400)" href="javascript:;">
      ...
      <div class="page">
        ...
        <div>
          <c:if test="${pageInfo.hasPreviousPage}">
            <a class="prev" href="${pageContext.request.contextPath}/chapter/list?page=${pageInfo.prePage}">&lt;&lt;</a>
          </c:if>
          ...
          <c:forEach items="${pageInfo.navigatepageNums}" var="p">
            ...
            <c:if test="${pageInfo.pageNum!=p}">
              <a class="num" href="${pageContext.request.contextPath}/chapter/list?page=${p}">${p}</a>
            </c:if>
          </c:forEach>
          <c:if test="${pageInfo.hasNextPage}">
            <a class="next" href="${pageContext.request.contextPath}/chapter/list?page=${pageInfo.nextPage}">&gt;&gt;</a>
          </c:if>
    ...
    <script>
      ...
      function delAll (argument) {
        ...
        layer.confirm('确认要删除吗？',function(index){
          $.ajax({
              type:"post",
              url:"${pageContext.request.contextPath}/chapter/deleteAll",
              data:{ids:data},
              dataType:"json",
              success:function (data) {
